...
export default function LoginPage() {
  ...
  function openDemoLogin(demo: (typeof DEMOS)[number]) {
    ...
    >
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        >
          ...
          >
            No account?{" "}
            <Link href="/signup" style={{ color: "#455c62", fontWeight: 500 }}>
              Create one →
            </Link>
          </p>
        </div>
        ...
        >
          ...
          {DEMOS.map((d) => (
            ...
            >
              ...
              <span style={{ fontSize: 12, color: "#455c62", fontWeight: 500 }}>
                Sign in →
              </span>
            </button>
          ))}
